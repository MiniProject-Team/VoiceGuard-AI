...
export interface AnalysisResponse { session_id:string; segment_id:number; status:'completed'; analysis:{synthetic_probability:number|null;speaker_similarity:number|null}; risk:RiskResult; alert:SecurityAlert|null }
...
export type ServerMessage =
 ...
 | {type:'analysis_result';session_id:string;segment_id:number;synthetic_probability:number|null;speaker_similarity:number|null;risk_score:number;risk_level:RiskResult['level'];decision:string}
